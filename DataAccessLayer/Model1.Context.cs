...
namespace DataAccessLayer
{
    ...
    public partial class bibliothequeEntities : DbContext
    {
        ...
        public virtual int CustomEmprunt_Create(Nullable<decimal> prixEmprunt, string exemplaireName, string userName, string biblio, Nullable<System.DateTime> date_de_retour)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CustomEmprunt_Create", prixEmpruntParameter, exemplaireNameParameter, userNameParameter, biblioParameter, date_de_retourParameter);
        }
        ...
        public virtual int livre_Create(string isbn, string titre, string auteur, string image)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("livre_Create", isbnParameter, titreParameter, auteurParameter, imageParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> Principal_Annexe(string user)
        {
            var userParameter = user != null ?
                new ObjectParameter("user", user) :
                new ObjectParameter("user", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("Principal_Annexe", userParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> NbreEmpruntAnnexe(string user)
        {
            var userParameter = user != null ?
                new ObjectParameter("user", user) :
                new ObjectParameter("user", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("NbreEmpruntAnnexe", userParameter);
        }
    
        public virtual ObjectResult<string> Select_BiblioPrincipale(string user)
        {
            var userParameter = user != null ?
                new ObjectParameter("user", user) :
                new ObjectParameter("user", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("Select_BiblioPrincipale", userParameter);
        }
    }
}
